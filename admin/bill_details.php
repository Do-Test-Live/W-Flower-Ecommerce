...
<head>
    ...
    <title>Bill Details | Four Seasons</title>
    <!-- Datatable -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example3" class="display min-w850">
                                    ...
                                    <tbody>
                                    <?php
                                    $bills = $db_handle->runQuery("SELECT * FROM `invoice_details` WHERE billing_id = '$billing_id'");
                                    $row_count = $db_handle->numRows("SELECT * FROM `invoice_details` WHERE billing_id = '$billing_id'");
