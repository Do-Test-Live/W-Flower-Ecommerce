...
<head>
    ...
    <title>Colors | Four Seasons</title>
    <!-- Datatable -->
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="Update" enctype="multipart/form-data">
                                        ...
                                        <?php $data = $db_handle->runQuery("SELECT * FROM flower_color where color_id={$_GET['color']}");?>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display min-w850">
                                        ...
                                        <tbody>
                                        <?php
                                        $color_data = $db_handle->runQuery("SELECT * FROM flower_color order by color_id desc");
                                        ...
                                        for ($i = 0; $i < $row_count; $i++) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="Color?color=<?php echo $color_data[$i]["color_id"]; ?>"
                                                           class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                                class="fa fa-pencil"></i></a>
                                                        <a onclick="categoryDelete(<?php echo $color_data[$i]["color_id"]; ?>);"
