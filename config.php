...
define('STRIPE_SUCCESS_URL', 'https://localhost/W-Flower-Ecommerce/payment-success.php'); //Payment success URL
define('STRIPE_CANCEL_URL', 'https://localhost/W-Flower-Ecommerce/payment-cancel.php'); //Payment cancel URL
