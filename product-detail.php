                ...
                <div class="header-container row">
                        ...
                        <nav>
                            <div class="mm-toggle-wrap">
                                <div class="mm-toggle">
                                    ...
                                    <i class="icon-align-cross" id="menu_icon_cross" style="display: none;"
                                       onclick="change_image_rep();"></i>
                                    <span
                            ...
                            <div class="nav-inner">
                                ...
                                <ul id="nav" class="hidden-xs">
                                    <!--<li class="mega-menu"><a class="level-top" href="category.php"><span>valentine's day flower</span></a>
                                        <div class="level0-wrapper dropdown-6col">
                                            <div class="container">
                                                <div class="level0-wrapper2">
                                                        ...
                                                        <div class="nav-block nav-block-center">
                                                            ...
                                                            <ul class="level0">
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>valentine bouquet</span></a>
                                                                </li>
                                                                &lt;!&ndash;level3 nav-6-1 parent item&ndash;&gt;
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>valentine's day gift</span></a>
                                                                </li>
                                                            </ul>
                                                            &lt;!&ndash;level0&ndash;&gt;
                                                        </div>
                                                    ...
                                                    &lt;!&ndash;col-1&ndash;&gt;
                                                    <div class="col-2">
                                                        <div class="menu_image"><a title="" href="category.php"><img
                                    ...
                                    <li class="mega-menu"><a class="level-top" href="category.php"><span>bouquet</span></a>
                                        <div class="level0-wrapper dropdown-6col">
                                            <div class="container">
                                                <div class="level0-wrapper2">
                                                    <div class="col-1">
                                                        <div class="nav-block nav-block-center">
                                                            ...
                                                            <ul class="level0">
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>bouquet of flowers</span></a>
                                                                    <!--sub sub category-->
                                                                    <ul class="level1">
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>Rose</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>hydrangea</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>sunflower</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>starry sky</span></a>
                                                                        </li>
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>tulip</span></a>
                                                                        </li>
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>carnation</span></a>
                                                                        </li>
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>calla lily</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                    </ul>
                                                                    <!--level1-->
                                                                ...
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>immortal bouquet</span></a>
                                                                    <!--sub sub category-->
                                                                    <ul class="level1">
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>standard</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>mini</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                        <li class="level2 nav-6-1-1"><a
                                                                                href="category.php"><span>single bouquet</span></a>
                                                                        </li>
                                                                        <!--level2 nav-6-1-1-->
                                                                    </ul>
                                                                    <!--level1-->
                                    ...
                                    <li class="mega-menu"><a class="level-top"
                                                             href="category.php"><span>rose bear</span></a>
                                        <div class="level0-wrapper dropdown-6col">
                                            <div class="container">
                                                <div class="level0-wrapper2">
                                                    <div class="col-1">
                                                        <div class="nav-block nav-block-center">
                                                            ...
                                                            <ul class="level0">
                                                                ...
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>giant</span></a>
                                                                </li>
                                                            </ul>
                                                            <!--level0-->
                                                        </div>
                                    ...
                                    <li class="mega-menu"><a class="level-top" href="category.php"><span>Flowers</span></a>
                                        <div class="level0-wrapper dropdown-6col">
                                            <div class="container">
                                                <div class="level0-wrapper2">
                                                    <div class="col-1">
                                                        <div class="nav-block nav-block-center">
                                                            ...
                                                            <ul class="level0">
                                                                ...
                                                                <!--level3 nav-6-1 parent item-->
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>flower box</span></a>
                                                                </li>
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>table flower</span></a>
                                                                </li>
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>bottle flower</span></a>
                                                                </li>
                                                            </ul>
                                                            <!--level0-->
                                                        </div>
                                    ...
                                    <li class="mega-menu"><a class="level-top" href="category.php"><span>preserved flower</span></a>
                                        <div class="level0-wrapper dropdown-6col">
                                            <div class="container">
                                                <div class="level0-wrapper2">
                                                    <div class="col-1">
                                                        <div class="nav-block nav-block-center">
                                                            ...
                                                            <ul class="level0">
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>Glass Cover</span></a>
                                                                </li>
                                                                <!--level3 nav-6-1 parent item-->
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>immortal bouquet</span></a>
                                                                ...
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>Preserved Flower × Bluetooth Speaker</span></a>
                                                                </li>
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>fantasy series</span></a>
                                                                </li>
                                                                <li class="level3 nav-6-1 parent item"><a
                                                                        href="category.php"><span>flower box</span></a>
                                                                </li>
                                    ...
                                    <li class="mega-menu"><a class="level-top" href="category.php"><span>orchid</span></a>
                                    </li>
                                    <li class="mega-menu"><a class="level-top"
                                                             href="category.php"><span>flower box</span></a></li>
                                </ul>
                                <!--nav-->
                            </div>
                        </nav>
                    ...
                    <div class="fl-header-right">
                                ...
                                <div class="fl-nav-links">
                                    <div class="language-currency">
                                        <div class="fl-language">
                                            <ul class="lang">
                                                <li><a href="category.php"> <img src="images/english.png"
                                                                                 alt="English"> <span>English</span>
                                                </a></li>
                                                <li><a href="category.php"> <img src="images/francais.png"
                                                                                 alt="French"> <span>French</span>
                                                </a></li>
                                                <li><a href="category.php"> <img src="images/german.png" alt="German">
                                        ...
                                        <div class="fl-currency">
                                            <ul class="currencies_list">
                                                <li><a href="category.php" title="EGP"> £</a></li>
                                                <li><a href="category.php" title="EUR"> €</a></li>
                                                <li><a href="category.php" title="USD"> $</a></li>
                                            </ul>
                                        </div>
                                        <!--fl-currency-->
                                        <!-- END For version 1,2,3,4,6 -->
                        ...
                        <div class="fl-cart-contain">
                            <div class="mini-cart">
                                <div class="basket"><a href="category.php"><span> 2 </span></a></div>
                            ...
                            <form action="#" method="post" id="product_addtocart_form">
                                ...
                                <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="product-image">
                                        <div class="product-full"><img id="product-zoom" src="images/flower/18.jpg"
                                                                       data-zoom-image="images/flower/18.jpg"
                                                ...
                                                <div id="gallery_01"
                                                    ...
                                                    <div class="slider-items slider-width-col4 block-content">
                                                        <div class="more-views-items"><a href="#"
                                                                                         data-image="images/flower/19.jpg"
                                                                                         data-zoom-image="images/flower/19.jpg">
                                                            <img id="product-zoom0" src="images/flower/19.jpg"
                                                                 onclick="related_image(this);"
                                                                 alt="product-image"/> </a></div>
                                                        <div class="more-views-items"><a href="#"
                                                                                         data-image="images/flower/19.jpg"
                                                                                         data-zoom-image="images/flower/20.jpg">
                                                            <img id="product-zoom1" src="images/flower/20.jpg"
                                                                 alt=" product-image" onclick="related_image(this);"/> </a></div>
                                                        <div class="more-views-items"><a href="#"
                                                                                         data-image="images/flower/21.jpg"
                                                                                         data-zoom-image="images/flower/21.jpg">
                                                            <img id="product-zoom2" src="images/flower/21.jpg"
                                                                 alt=" product-image" onclick="related_image(this);"/> </a></div>
                                                        <div class="more-views-items"><a href="#"
                                                                                         data-image="images/flower/22.jpg"
                                                                                         data-zoom-image="images/flower/22.jpg">
                                                            <img id="product-zoom3" src="images/flower/22.jpg"
                                                                 alt="product-image" onclick="related_image(this);"/> </a></div>
                                                        <div class="more-views-items"><a href="#"
                                                                                         data-image="images/flower/23.jpg"
                                                                                         data-zoom-image="images/flower/23.jpg">
                                                            <img id="product-zoom4" src="images/flower/23.jpg"
                                                                 alt="product-image" onclick="related_image(this);"/> </a></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="price-block">
                                        <div class="price-box">
                                            ...
                                            <p class="special-price"><span class="price-label">Special Price</span>
                                                <span id="product-price-48" class="price"> 125.00 HKD </span></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                            ...
                                                            src="images/flower/10.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        <div class="item-title"><a href="product-detail.html"
                                                                                   title="Test Flower">Test Flower</a>
                                                        </div>
                                                        <div class="item-content">
                                                            <div class="item-price">
                                                                <div class="price-box"><span class="regular-price"><span
                                                                        class="price">125.00 HKD</span> </span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                                                  title="Test Flower"
                                                                                  class="product-image"><img
                                                            src="images/flower/11.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                        <button class="button btn-cart" type="button">
                                                            <span>Add to Cart</span></button>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                                                  title="Test Flower"
                                                                                  class="product-image"><img
                                                            src="images/flower/12.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                        <button class="button btn-cart" type="button">
                                                            <span>Add to Cart</span></button>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                                                  title="Test Flower"
                                                                                  class="product-image"><img
                                                            src="images/flower/13.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                        <button class="button btn-cart" type="button">
                                                            <span>Add to Cart</span></button>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                                                  title="Test Flower"
                                                                                  class="product-image"><img
                                                            src="images/flower/14.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                        <button class="button btn-cart" type="button">
                                                            <span>Add to Cart</span></button>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a href="product-detail.html"
                                                                                  title="Test Flower"
                                                                                  class="product-image"><img
                                                            src="images/flower/15.jpg" alt="Test Flower"></a>
                                                    </div>
                                                    <div class="add_cart">
                                                        <button class="button btn-cart" type="button">
                                                            <span>Add to Cart</span></button>
