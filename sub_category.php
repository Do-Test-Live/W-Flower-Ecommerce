...
$fetch_product = $db_handle->runQuery("SELECT * FROM product where sub_category='$sub_category' LIMIT 9 OFFSET $offset");
$no_fetch_product = $db_handle->numRows("SELECT * FROM product where sub_category='$sub_category' LIMIT 9 OFFSET $offset");
?>
                            ...
                            <div class="category-products">
                                ...
                                if (isset($_GET['color'])) {
                                    ...
                                    <ul class="products-grid">
                                        <?php
                                        $color_id = $_GET['color'];
                                        $product_color = $db_handle->runQuery("SELECT * FROM product where sub_category='$sub_category' and product_color = '$color_id' LIMIT 9 OFFSET $offset");
                                        $no_product_color = $db_handle->numRows("SELECT * FROM product where sub_category='$sub_category' and product_color = '$color_id' LIMIT 9 OFFSET $offset");
                                        ...
                                        <div class="display-product-option">
                                            <div class="pages">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    $new = $db_handle->runQuery("SELECT COUNT('id') as c FROM product where sub_category='$sub_category' and product_color = '$color_id'");
                                                    $no_new = $db_handle->numRows("SELECT COUNT('id') as c FROM product where sub_category='$sub_category' and product_color = '$color_id'");

                                                    $total_pages = ceil($new[0]['c'] / 9);
                                                    for ($i = 1; $i <= $total_pages; $i++) {
                                                        ?>
                                                        <li>
                                                            <a href="Sub-Category?id=<?php echo $sub_category; ?>&color=<?php echo $color_id; ?>&page=<?php echo $i; ?>"><?php echo $i ?></a>
                                                        </li>
                                                        <?php
                                                    }
                                                    ?>
                                    ...
                                    if ($_GET['price'] == '1') {
                                        ...
                                        <ul class="products-grid">
                                            <?php
                                            $product_price = $db_handle->runQuery("SELECT * FROM product where sub_category='$sub_category' and product_price < 100 LIMIT 9 OFFSET $offset");
                                            $no_product_price = $db_handle->numRows("SELECT * FROM product where sub_category='$sub_category' and product_price < 100 LIMIT 9 OFFSET $offset");
                                            ...
                                            <div class="display-product-option">
                                                <div class="pages">
                                                    ...
                                                    <ul class="pagination">
                                                        <?php
                                                        // calculate the total number of pages
                                                        $new = $db_handle->runQuery("SELECT COUNT('id') as c FROM product where sub_category='$sub_category' and product_price < '100'");
                                                        $no_new = $db_handle->numRows("SELECT COUNT('id') as c FROM product where sub_category='$sub_category' and product_price < '100'");

                                                        $total_pages = ceil($new[0]['c'] / 9);
                                                        for ($i = 1; $i <= $total_pages; $i++) {
                                                            ?>
                                                            <li>
                                                                <a href="Sub-Category?id=<?php echo $sub_category; ?>&price=1&page=<?php echo $i; ?>"><?php echo $i ?></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ?>
                                        ...
                                        <div class="display-product-option">
                                            <div class="pages">
                                                ...
                                                <ul class="pagination">
                                                    <?php
                                                    // calculate the total number of pages
                                                    $new = $db_handle->runQuery("SELECT COUNT('id') as c FROM product where sub_category ='$sub_category'");
                                                    $no_new = $db_handle->numRows("SELECT COUNT('id') as c FROM product where sub_category ='$sub_category'");

                                                    $total_pages = ceil($new[0]['c'] / 9);
                                                    for ($i = 1; $i <= $total_pages; $i++) {
                                                        ?>
                                                        <li>
                                                            <a href="Sub-Category?id=<?php echo $sub_category ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                                                        </li>
                                                        <?php
                                                    }
                                                    ?>
