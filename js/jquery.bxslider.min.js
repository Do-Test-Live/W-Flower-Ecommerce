...
(function (t) {
        ...
        if (this.length != 0) {
            ...
            var a = function () {
                ...
                v(e, "reset", 0), o.settings.pager = !1, o.settings.controls = !1, o.settings.autoControls = !1, o.settings.tickerHover && !o.usingCSS && o.viewport.hover(function () {
                    ...
                    var i = o.settings.speed / e, n = o.settings.mode == "horizontal" ? "left" : "top",
                ...
                var n = o.settings.mode == "horizontal" ? -e.left : -e.top,
                    s = o.settings.mode == "horizontal" ? -i.left : -i.top, a = {resetValue: s};
                v(n, "ticker", speed, a)
            }, D = function () {
    ...
    t.fn.imagesLoaded = function (n) {
        ...
        var r = this, a = t.isFunction(t.Deferred) ? t.Deferred() : 0, l = t.isFunction(a.notify),
